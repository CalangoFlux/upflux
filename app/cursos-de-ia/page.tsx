...
export default function CursosIA() {
        ...
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden lg:flex items-center space-x-8">
              ...
              <Link href="/cursos-de-ia" className="text-cyan-400 transition-all duration-300 relative group">
                Cursos de IA
        ...
        {isMenuOpen && (
          <div className="lg:hidden border-t border-white/10 bg-black/40 backdrop-blur-xl">
            <nav className="flex flex-col p-6 space-y-4">
              ...
              <Link href="/cursos-de-ia" className="text-cyan-400 transition-colors duration-300">
                Cursos de IA
              </Link>
        ...
        >
          ...
          <div className="flex justify-center mb-12">
            <div className="relative">
              ...
              <div className="w-40 h-40 animate-spin" style={{ animationDuration: "8s" }}>
          ...
          <div className="space-y-6 max-w-2xl mx-auto">
            ...
            <p className="text-lg text-gray-400 leading-relaxed">
              Estamos preparando conteúdos educacionais exclusivos sobre inteligência artificial para você dominar as
